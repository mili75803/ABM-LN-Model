...
//
//
//public class AgentsSetting_ extends SimState
//{
...
//    int fileNum;
//    Display3D display3d;
//    public AgentsSetting_(long seed, double LNside, int TCCloneType, int TotalTC, int DCCloneType, int TotalDC, int fileNum, ContinuousPortrayal3D agitatedYardPortrayal, Display3D display3d)
//    {
//        super(seed);
//        this.noOfDC = TotalDC;
...
//    }
//    
//      public AgentsSetting_(long seed, double LNside, int TCCloneType, int TotalTC, int DCCloneType, int TotalDC, int fileNum)
//    {
//        super(seed);
//        this.noOfDC = TotalDC;
//        this.noOfTCell = TotalTC;
...
//            {
//               
//                TCell t_cell = new TCell(this, LN, LNSide, scale, DCList, this.noOfTCell, sem, TotalIteration, fileNum, count, DCFirstDetectTime, sumContactTime, lastFirstContactTime, contactTime, agitatedYardPortrayal, display3d);
...
//        for(int i = 0; i < agents.size(); i++)
//        {
//            TCell agent = (TCell)(agents.get(i));
//            Double2D loc = (Double2D)(yard.getObjectLocation(agent));
//            agitatedYard.setObjectLocation(agent, new Double3D(loc, agent.z));
//        }
...
//    /*    public static void main(String[] args)
//    {
//        doLoop(AgentsSetting_.class, args);
//        System.exit(0);
//    }
//        */
//    
